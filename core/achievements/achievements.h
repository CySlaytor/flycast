...
namespace achievements
{
	...
	// Manually toggle integration (load DLL and attach menu)
	void enableRAIntegration(bool enable);
	bool isRAIntegrationEnabled();
	const char *getRAIntegrationStatus(); // Returns detailed status string
	...
	static inline bool canPause() {return true;}
	// Stubs for non-RA builds
